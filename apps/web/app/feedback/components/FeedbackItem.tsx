        ...
        {imageUrl ? (
          <div className="relative flex-1 rounded-lg overflow-hidden h-[180px]">
            ...
            <div className="absolute right-4 bottom-4 rounded-lg flex items-center gap-1 bg-white p-2">
              <ImageIcon size={16} />
              <span className="font-semibold text-sm text-foreground">+2</span>
            </div>
          </div>
        ) : (
      ...
      <CardContent className="space-y-4 px-4">
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-muted-foreground">Sub Kategori</span>
          </div>
        ...
        <div className="border rounded-md space-y-2 bg-muted/50 p-4">
          <div className="flex items-center gap-2">
            <MessageSquareDashed size={16} className="text-muted-foreground" />
